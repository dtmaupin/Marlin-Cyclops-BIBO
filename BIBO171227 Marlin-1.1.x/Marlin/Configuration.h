...
#define STRING_CONFIG_H_AUTHOR "(DinkyMods, Daniel Maupin)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Dinks Bibo"
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (15*100)
#define HOMING_FEEDRATE_Z  (5*70)
